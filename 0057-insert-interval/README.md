...
## Solution Approach 
* same as this https://github.com/hemanthnarayanaswamy/leetcode_coding_problems/blob/main/0056-merge-intervals/README.md
* We added the new interval into the array than sorted the array and performed the look up on 
* Complexity is `O(nlongn)` but it works 
