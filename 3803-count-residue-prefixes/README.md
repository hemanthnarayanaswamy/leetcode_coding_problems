<h2><a href="https://leetcode.com/problems/count-residue-prefixes/?envType=problem-list-v2&envId=d2opnzwc">4186. Count Residue Prefixes</a></h2><h3>Easy</h3><hr><p>You are given a string <code>s</code> consisting only of lowercase English letters.</p>
